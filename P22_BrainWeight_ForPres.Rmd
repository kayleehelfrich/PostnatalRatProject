---
title: "P22 Offspring Brain Weights, AIN-76A diet with MD or Alcohol and Iron Supplement or Water"
author: "Kaylee Helfrich"
date: "2/12/2021"
output: 
  pdf_document: default
  html_document: default
data: "Offspring_Organ_Weights_P22_CLEAN.csv"
---
...
# Graphing P22 Brain Weights
This document details my graphing of the brain weights on P22 from the postnatal portion of the rat study. This data includes all animals that were collected at P22. The graphs include left and right brain weights (and cerebrum weight), cerebellum weight, total brain weight, and body weight to brain ratio. All data within this analysis was collected by Kaylee Helfrich and Rachel Hodges.
...
File <- "Offspring_Organ_Weights_P22_CLEAN.csv"
...
#Make Graph#
png("P22_TotalBrainWtMales_AllData_PAExFe_Dotplot_ForPres.png", units="in", width=4, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Exposure, y=Mean)) + 
  ...
  #ggtitle("P22- Total Brain Weight- Males") +
...
dev.off() 
```
```{r P22 Male Total Brain Weight, echo = FALSE}
print(p)
```
...
#Make Graph#
png("P22_TotalBrainWtFemales_AllData_PAExFe_Dotplot_ForPres.png", units="in", width=4, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Exposure, y=Mean)) + 
  ...
  geom_point(aes(x=Exposure, y=Value),
             size = 1.25, shape = 19, position = position_jitter(width=.15, height = 0)) +
  scale_y_continuous(expand = c(0,0), limits = c(0,2.1)) +
  #ggtitle("P22- Total Brain Weight- Females") +
  ylab(expression("Weight (g)")) + 
  theme(plot.title = element_text(hjust = 0.5, size=18, family = "Times New Roman"), 
        axis.title.x = element_blank(), #gets rid of x-axis label
        axis.title.y = element_text(size = 28),
...
dev.off() 
```
```{r P22 Female Total Brain Weight, echo = FALSE}
print(p)
```

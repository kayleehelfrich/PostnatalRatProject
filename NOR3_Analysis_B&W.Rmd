---
title: "Offspring Performance on the Novel Object Recognition Test- 24 hour delay recognition (NOR3), AIN-76A diet with MD or Alcohol and Iron Supplement or Water- P30"
author: "Kaylee Helfrich"
date: "1/27/2021"
output: 
  pdf_document: default
  html_document: default
data: "NovelObjectRecognition_CLEAN_UsableSamples_NOR3.csv"
---
...
File <- "NovelObjectRecognition_CLEAN_UsableSamples_NOR3.csv"
...
#Make Graph#
png("NOR3_Male_PercentTimeWithNovelObject_AllData_PAExFe_Dotplot_B&W.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Exposure, y=Mean)) + 
  ...
  ggtitle("Males- Percent Time with Novel Object- 24 hour delay") +
...
#Make Graph#
png("NOR3_Female_PercentTimeWithNovelObject_AllData_PAExFe_Dotplot_B&W.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Exposure, y=Mean)) + 
  ...
  geom_point(aes(x=Exposure, y=Value),
             size = 1.25, shape = 19, position = position_jitter(width=.15, height = 0)) +
  scale_y_continuous(expand = c(0,0), limits = c(0,100)) +
  ggtitle("Females- Percent Time with Novel Object- 24 hour delay") +
  geom_hline(yintercept=50, linetype="dashed", color = "black", size=1) +
  ylab(expression("Percent Time with Novel Object (%)")) + 
  theme(plot.title = element_text(hjust = 0.5, size=18, family = "Times New Roman"), 
        axis.title.x = element_blank(), #gets rid of x-axis label
